...
import com.quartzy.pathfinding.input.Clicked;
import com.quartzy.pathfinding.input.Mouse;
...
public class GuiButton extends GuiComponent {
    ...
    public void render(Graphics g) {
        ...
        g.drawString(text, getX() + (getWidth()-borderThickness*4) -(int) floats[2], (int) (getY() + getHeight()/2 + floats[1]/3));
    }
